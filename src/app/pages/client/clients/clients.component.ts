...
@Component({
  ...
  <div class="flex flex-column md:flex-row justify-content-between align-items-center mb-4 gap-3">
    <h2 class="m-0 text-900 font-semibold">Gestión de Clientes</h2>
    <p-button
      label="Nuevo Cliente"
      icon="pi pi-plus"
      (onClick)="openNew()">
  ...
  <!-- Filtros -->
  <div class="grid surface-section p-3 border-round mb-4 gap-4">
...
<p-dialog
  ...
  <form (ngSubmit)="saveClient()" #clientForm="ngForm">
    <div class="grid formgrid">
      ...
      <div class="col-12">
        <label class="block mb-2">Fuente</label>
        <input
          pInputText
